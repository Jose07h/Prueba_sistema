 ...
 */
    ...
    class informes_municipioPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Informes Municipio');
            $this->SetMenuLabel('Informes Municipio');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('documento_1_edit');
            $editor->SetMaxLength(255);
            $editColumn = new CustomEditColumn('Documento 1', 'documento_1', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new TextEdit('documento_2_edit');
            $editor->SetMaxLength(255);
            $editColumn = new CustomEditColumn('Documento 2', 'documento_2', $editor, $this->dataset);
    ...
    try
    {
        $Page = new informes_municipioPage("informes_municipio", "informes_municipio.php", GetCurrentUserPermissionsForPage("informes_municipio"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("informes_municipio"));
