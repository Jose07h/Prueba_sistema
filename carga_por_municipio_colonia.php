 ...
 */
    ...
    class carga_por_municipio_coloniaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Carga Por Municipio Colonia');
            $this->SetMenuLabel('Carga Por Municipio Colonia');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`carga_por_municipio_colonia`');
    ...
    try
    {
        $Page = new carga_por_municipio_coloniaPage("carga_por_municipio_colonia", "carga_por_municipio_colonia.php", GetCurrentUserPermissionsForPage("carga_por_municipio_colonia"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("carga_por_municipio_colonia"));
