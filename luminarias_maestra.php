 ...
 */
    ...
    class luminarias_maestraPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Luminarias Detalle');
            $this->SetMenuLabel('Luminarias Detalle');
    ...
    try
    {
        $Page = new luminarias_maestraPage("luminarias_maestra", "luminarias_maestra.php", GetCurrentUserPermissionsForPage("luminarias_maestra"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("luminarias_maestra"));
