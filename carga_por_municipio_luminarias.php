 ...
 */
    ...
    class carga_por_municipio_luminariasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Carga Por Municipio Luminarias');
            $this->SetMenuLabel('Carga Por Municipio Luminarias');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`carga_por_municipio_luminarias`');
    ...
    try
    {
        $Page = new carga_por_municipio_luminariasPage("carga_por_municipio_luminarias", "carga_por_municipio_luminarias.php", GetCurrentUserPermissionsForPage("carga_por_municipio_luminarias"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("carga_por_municipio_luminarias"));
