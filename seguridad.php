 ...
 */
    ...
    class seguridadPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Seguridad');
            $this->SetMenuLabel('Seguridad');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_seguridad', true, true, true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_seguridad', 'id_seguridad', 'Id Seguridad'),
        ...
        {
            $quickFilter
                ->addColumn($columns['id_seguridad'])
        ...
        {
            //
            // View column for id_seguridad field
            //
            $column = new NumberViewColumn('id_seguridad', 'id_seguridad', 'Id Seguridad', $this->dataset);
    ...
    try
    {
        $Page = new seguridadPage("seguridad", "seguridad.php", GetCurrentUserPermissionsForPage("seguridad"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("seguridad"));
