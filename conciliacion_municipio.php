 ...
 */
    ...
    class conciliacion_municipioPage extends Page
    {
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('conciliado_edit');
    ...
    try
    {
        $Page = new conciliacion_municipioPage("conciliacion_municipio", "conciliacion_municipio.php", GetCurrentUserPermissionsForPage("conciliacion_municipio"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("conciliacion_municipio"));
