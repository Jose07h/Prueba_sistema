 ...
 */
    ...
    class vias_secundarias_carga_por_coloniaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Vias Secundarias Carga Por Colonia');
            $this->SetMenuLabel('Vias Secundarias Carga Por Colonia');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`vias_secundarias_carga_por_colonia`');
            $this->dataset->addFields(
                array(
                    ...
                    new IntegerField('total_luminarias', false, true),
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'total_luminarias', 'total_luminarias', 'Total Luminarias'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['total_luminarias'])
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for total_luminarias field
            //
            $column = new NumberViewColumn('total_luminarias', 'total_luminarias', 'Total Luminarias', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for total_luminarias field
            //
            $editor = new TextEdit('total_luminarias_edit');
            $editColumn = new CustomEditColumn('Total Luminarias', 'total_luminarias', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new vias_secundarias_carga_por_coloniaPage("vias_secundarias_carga_por_colonia", "vias_secundarias_carga_por_colonia.php", GetCurrentUserPermissionsForPage("vias_secundarias_carga_por_colonia"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("vias_secundarias_carga_por_colonia"));
