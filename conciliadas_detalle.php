 ...
 */
    ...
    class conciliadas_detallePage extends Page
    {
    ...
    try
    {
        $Page = new conciliadas_detallePage("conciliadas_detalle", "conciliadas_detalle.php", GetCurrentUserPermissionsForPage("conciliadas_detalle"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("conciliadas_detalle"));
