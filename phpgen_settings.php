...
function GetPageGroups()
{
    ...
    $result[] = array('caption' => 'Detalle Y Mapas', 'description' => '');
    return $result;
}
...
{
    $result = array();
    $result[] = array('caption' => 'Conciliacion', 'short_caption' => 'Conciliacion', 'filename' => 'conciliacion_validacion.php', 'name' => 'conciliacion_validacion', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Conciliacion Municipio', 'short_caption' => 'Conciliacion Municipio', 'filename' => 'conciliacion_municipio.php', 'name' => 'conciliacion_municipio', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Avance Luminarias Censadas', 'short_caption' => 'Avance Luminarias Censadas', 'filename' => 'avance_luminarias_censadas.php', 'name' => 'avance_luminarias_censadas', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Informes', 'short_caption' => 'Informes', 'filename' => 'informes.php', 'name' => 'informes', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => 'Cartografias', 'short_caption' => 'Cartografias', 'filename' => 'cartografias.php', 'name' => 'cartografias', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => 'Fichas Tecnicas', 'short_caption' => 'Fichas Tecnicas', 'filename' => 'fichas_tecnicas.php', 'name' => 'fichas_tecnicas', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => 'Vias Primarias Detalle', 'short_caption' => 'Vias Primarias Detalle', 'filename' => 'vias_primarias_maestra.php', 'name' => 'vias_primarias_maestra', 'group_name' => 'Detalle Y Mapas', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Vias Secundarias Detalle', 'short_caption' => 'Vias SecundariasDetalle', 'filename' => 'vias_secundarias_maestra.php', 'name' => 'vias_secundarias_maestra', 'group_name' => 'Detalle Y Mapas', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => 'Vias Primarias Carga Por Colonia', 'short_caption' => 'Vias Primarias Carga Por Colonia', 'filename' => 'vias_primarias_carga_por_colonia.php', 'name' => 'vias_primarias_carga_por_colonia', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Vias Secundarias Carga Por Colonia', 'short_caption' => 'Vias Secundarias Carga Por Colonia', 'filename' => 'vias_secundarias_carga_por_colonia.php', 'name' => 'vias_secundarias_carga_por_colonia', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
