 ...
 */
    ...
    class vias_secundarias_maestraPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Vias SecundariasDetalle');
            $this->SetMenuLabel('Vias Secundarias Detalle');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`vias_secundarias_maestra`');
        ...
        protected function setupColumnFilter(ColumnFilter $columnFilter)
        {
            $columnFilter
                ...
                ->setOptionsFor('watts')
                ->setOptionsFor('porcentaje_perdida')
    ...
    try
    {
        $Page = new vias_secundarias_maestraPage("vias_secundarias_maestra", "vias_secundarias_maestra.php", GetCurrentUserPermissionsForPage("vias_secundarias_maestra"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("vias_secundarias_maestra"));
