 ...
 */
    ...
    class seguridad_rijPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Seguridad Rij');
            $this->SetMenuLabel('Seguridad Rij');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_seguridad_rij', true, true, true),
                    new DateField('fecha', true),
                    new StringField('tipo_reunion', true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_seguridad_rij', 'id_seguridad_rij', 'Id Seguridad Rij'),
        ...
        {
            $quickFilter
                ->addColumn($columns['id_seguridad_rij'])
        ...
        {
            //
            // View column for id_seguridad_rij field
            //
            $column = new NumberViewColumn('id_seguridad_rij', 'id_seguridad_rij', 'Id Seguridad Rij', $this->dataset);
    ...
    try
    {
        $Page = new seguridad_rijPage("seguridad_rij", "seguridad_rij.php", GetCurrentUserPermissionsForPage("seguridad_rij"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("seguridad_rij"));
