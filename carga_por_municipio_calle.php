 ...
 */
    ...
    class carga_por_municipio_callePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Carga Por Municipio Calle');
            $this->SetMenuLabel('Carga Por Municipio Calle');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`carga_por_municipio_calle`');
    ...
    try
    {
        $Page = new carga_por_municipio_callePage("carga_por_municipio_calle", "carga_por_municipio_calle.php", GetCurrentUserPermissionsForPage("carga_por_municipio_calle"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("carga_por_municipio_calle"));
