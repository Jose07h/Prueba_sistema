 ...
 */
    ...
    class vias_primarias_carga_por_coloniaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Vias Primarias Carga Por Colonia');
            $this->SetMenuLabel('Vias Primarias Carga Por Colonia');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`vias_primarias_carga_por_colonia`');
    ...
    try
    {
        $Page = new vias_primarias_carga_por_coloniaPage("vias_primarias_carga_por_colonia", "vias_primarias_carga_por_colonia.php", GetCurrentUserPermissionsForPage("vias_primarias_carga_por_colonia"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("vias_primarias_carga_por_colonia"));
