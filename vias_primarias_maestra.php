 ...
 */
    ...
    class vias_primarias_maestraPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Vias Primarias Detalle');
            $this->SetMenuLabel('Vias Primarias Detalle');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`vias_primarias_maestra`');
    ...
    try
    {
        $Page = new vias_primarias_maestraPage("vias_primarias_maestra", "vias_primarias_maestra.php", GetCurrentUserPermissionsForPage("vias_primarias_maestra"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("vias_primarias_maestra"));
