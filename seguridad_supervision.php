 ...
 */
    ...
    class seguridad_supervisionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Seguridad Supervision');
            $this->SetMenuLabel('Seguridad Supervision');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`seguridad_supervision`');
            $this->dataset->addFields(
                array(
                    new IntegerField('id_seguridad_supervision', true, true, true),
                    new DateField('fecha'),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_seguridad_supervision', 'id_seguridad_supervision', 'Id Seguridad Supervision'),
        ...
        {
            $quickFilter
                ->addColumn($columns['id_seguridad_supervision'])
        ...
        {
            //
            // View column for id_seguridad_supervision field
            //
            $column = new NumberViewColumn('id_seguridad_supervision', 'id_seguridad_supervision', 'Id Seguridad Supervision', $this->dataset);
    ...
    try
    {
        $Page = new seguridad_supervisionPage("seguridad_supervision", "seguridad_supervision.php", GetCurrentUserPermissionsForPage("seguridad_supervision"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("seguridad_supervision"));
