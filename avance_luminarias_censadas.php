 ...
 */
    ...
    class avance_luminarias_censadasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Avance Luminarias Censadas');
            $this->SetMenuLabel('Avance Luminarias Censadas');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`avance_luminarias_censadas`');
            $this->dataset->addFields(
                array(
                    new StringField('municipio'),
                    new StringField('fecha_captura', false, true),
                    new IntegerField('user_id', false, true),
                    new IntegerField('luminarias_censadas', true, true)
                )
            );
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'luminarias_censadas', 'luminarias_censadas', 'Luminarias Censadas'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['luminarias_censadas'])
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for luminarias_censadas field
            //
            $column = new NumberViewColumn('luminarias_censadas', 'luminarias_censadas', 'Luminarias Censadas', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for luminarias_censadas field
            //
            $editor = new TextEdit('luminarias_censadas_edit');
            $editColumn = new CustomEditColumn('Luminarias Censadas', 'luminarias_censadas', $editor, $this->dataset);
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('fecha_captura', 'DESC');
    ...
    try
    {
        $Page = new avance_luminarias_censadasPage("avance_luminarias_censadas", "avance_luminarias_censadas.php", GetCurrentUserPermissionsForPage("avance_luminarias_censadas"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("avance_luminarias_censadas"));
