 ...
 */
    ...
    class carga_por_municipio_semaforosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Carga Por Municipio Semaforos');
            $this->SetMenuLabel('Carga Por Municipio Semaforos');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`carga_por_municipio_semaforos`');
    ...
    try
    {
        $Page = new carga_por_municipio_semaforosPage("carga_por_municipio_semaforos", "carga_por_municipio_semaforos.php", GetCurrentUserPermissionsForPage("carga_por_municipio_semaforos"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("carga_por_municipio_semaforos"));
