 ...
 */
    ...
    class fichas_tecnicas_municipioPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Fichas Tecnicas Municipio');
            $this->SetMenuLabel('Fichas Tecnicas Municipio');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`fichas_tecnicas_municipio`');
    ...
    try
    {
        $Page = new fichas_tecnicas_municipioPage("fichas_tecnicas_municipio", "fichas_tecnicas_municipio.php", GetCurrentUserPermissionsForPage("fichas_tecnicas_municipio"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("fichas_tecnicas_municipio"));
