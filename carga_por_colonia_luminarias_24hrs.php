 ...
 */
    ...
    class carga_por_colonia_luminarias_24hrsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Carga Por Colonia Luminarias 24hrs');
            $this->SetMenuLabel('Carga Por Colonia Luminarias 24hrs');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`carga_por_colonia_luminarias_24hrs`');
    ...
    try
    {
        $Page = new carga_por_colonia_luminarias_24hrsPage("carga_por_colonia_luminarias_24hrs", "carga_por_colonia_luminarias_24hrs.php", GetCurrentUserPermissionsForPage("carga_por_colonia_luminarias_24hrs"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("carga_por_colonia_luminarias_24hrs"));
